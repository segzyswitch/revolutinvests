  ...
  <div class="section py-5">
    <div class="d-flex flex-column gap-5 p-5 bg-gradient-footer rounded-4 accent-primary">
      <div class="d-flex flex-xl-row flex-column gap-3 justify-content-between align-items-center">
        <img src="logo.png" alt="" class="img-fluid" width="165">
        <div class="d-flex flex-xl-row flex-column gap-4">
          <div>
            <a href="./" class="link d-flex flex-row gap-3 align-items-center">Home</a>
          </div>
          <div>
            <a href="./about" class="link d-flex flex-row gap-3 align-items-center">About Us</a>
          </div>
          <div>
            <a href="./faqs" class="link d-flex flex-row gap-3 align-items-center">FAQs</a>
          </div>
          <div>
            <a href="./contact" class="link d-flex flex-row gap-3 align-items-center">Contact Us</a>
          </div>
        </div>
      ...
      <div class="d-flex flex-column gap-2 align-items-center justify-content-center accent-primary">
        ...
        <div class="d-flex flex-column gap-3 width-subscribe">
          <div class="toast-container position-fixed bottom-0 end-0 p-3">
            <div id="liveToast" class="toast success_msg_subscribe bg-dark-transparent text-white" role="alert"
          ...
          <div>
            <form class="d-flex flex-column h-100 justify-content-center w-100 needs-validation form" novalidate>
              ...
              <div class="input-group gap-3 mb-xl-2 mb-0 position-relative custom-input-group">
                <input type="email" class="form-control subscribe custom-email-input" placeholder="E-mail"
                  name="email" required>
                <button
      ...
      <div class="d-flex flex-xl-row flex-column gap-xl-2 gap-3 align-items-center justify-content-between">
        <span class="text-white fs-6 font-2">
          Copyright © 2024 Maxamus Invest. All Rights Reserved.
        </span>
