...
<head>
	...
	<title>Investment plans - Revolut Invests</title>
				...
				foreach ($Controller->Plans() as $key => $value) {
					...
					<div class="col-sm-4">
						<div class="card plan-card text-center p-4 py-5">
							<p class="display-4 mb-4"><i class="rtmicon rtmicon-<?php echo $value['icon']; ?>"></i></p>
							...
							<a href="./schema-preview?plan=<?php echo $value['id'] ?>"
								...
								<small><i class="bi bi-check"></i>Select Plan</small>
							</a>
						</div>
					</div>
					<?php
