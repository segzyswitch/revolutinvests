...
<head>
	...
	<title>Verify Token - Revolut Invests</title>
				...
				<div class="card sm-shadow-sm">
					...
					<div class="card-body p-4">
						...
						<form id="tokenForm">
							...
							<button type="submit" class="btn text-dark bg-primary submit-btn w-100 mb-4">Verify token <i class="bi bi-arrow-right"></i></button>
							<div class="text-center">
								<a href="#" class="text-decoration-none small">I don't have a token?</a>
							</div>
						</form>
