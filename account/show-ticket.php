...
<head>
	...
	<meta name="keywords" content="Maxamus Invest">
	<meta name="description" content="Maxamus Invest">
	<link rel="canonical" href="https://zenithwealthpro.com/account/user/support-ticket/show/SUPT885960" />
	...
	<title>Maxamus Invest - Add New Support Ticket
	</title>
							...
							<div class="col-xl-12">
								<div class="site-card overflow-hidden">
									<div class="site-card-header">
										<h3 class="title"> KYC Help - SUPT885960 <span class="site-badge badge-success">Opened</span></h3>
										<div class="card-header-links">
											<a href="https://zenithwealthpro.com/account/user/support-ticket/close-now/SUPT885960"
												class="card-header-link rounded-pill">Mark it close</a>
										</div>
									</div>
										...
										<div class="support-ticket-single-message user">
											<div class="logo">
												<img class="avatar avatar-round"
													src="https://zenithwealthpro.com/account/assets/global/materials/user.png" alt="" height="40"
													width="40">
											</div>
											...
											<div class="message-footer">
												<div class="name">Ronald Hoymme</div>
												<div class="email"><a href="mailto:">ronaldhoymme@gmail.com</a></div>
											</div>
											<div class="message-attachments">
												...
												<div class="single-attachment">
													...
													<div class="attach">
														<a href="https://zenithwealthpro.com/account/assets" target="_blank"><i
																class="anticon anticon-picture"></i></a>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="site-card">
									<div class="site-card-body">
										<div class="progress-steps-form">
											<form action="https://zenithwealthpro.com/account/user/support-ticket/reply" method="post"
												enctype="multipart/form-data">
												<input type="hidden" name="_token" value="0PBnSGpBOeU6uMyjETolsJPb2ENYjKaQCWd9mtKF">
												<input type="hidden" name="uuid" value="SUPT885960">
												<div class="row mb-3">
														...
														<div class="wrap-custom-file">
															...
															<label for="attach">
																<img class="upload-icon"
																	src="https://zenithwealthpro.com/account/assets/global/materials/upload.svg" alt="" />
