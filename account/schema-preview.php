...
<head>
	...
	<title>Trading View - Revolut Invests</title>
					...
					<div class="card d-none" id="reviewPlan">
						...
						<form method="POST" id="investForm" class="card-body">
							...
							<div class="row mb-0">
								...
								<div class="col-6">
									<button type="submit" class="btn bg-primary text-dark w-100 submit-btn">Start investment</button>
								</div>
							</div>
						</form>
					</div>
				...
				<div class="col-lg-4">
					...
					<div class="card">
						<div class="card-body text-center">
							...
							<button class="btn bg-primary text-dark w-100">Contact Support</button>
						</div>
					</div>
				</div>
			</div>
