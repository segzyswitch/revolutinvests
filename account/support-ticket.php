...
<head>
	...
	<title>Maxamus Invest - Support Tickets
	</title>
								...
								<div class="site-card">
									<div class="site-card-header">
										...
										<div class="card-header-links">
											<a href="https://zenithwealthpro.com/account/user/support-ticket/new"
												class="card-header-link">Create Ticket</a>
										</div>
									</div>
										...
										<div class="site-transactions">
											<div class="single">
												<div class="left">
													...
													<div class="content">
														<div class="title">KYC Help</div>
														<div class="date">Created Sep 12 2025 10:32
															<span class="ms-2 status site-badge badge-pending">Opened</span>
												...
												<div class="right">
													<div class="action">
														...
														<a href="https://zenithwealthpro.com/account/user/support-ticket/close-now/SUPT885960"
															class="cancel" data-bs-toggle="tooltip" title="Complete Ticket"
															data-bs-original-title="Complete Ticket"><i icon-name="check"></i></a>
														<a href="https://zenithwealthpro.com/account/user/support-ticket/show/SUPT885960"
															data-bs-toggle="tooltip" title="Show Ticket" data-bs-original-title="Show Ticket"><i
																icon-name="eye"></i></a>
