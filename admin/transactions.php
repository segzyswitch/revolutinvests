...
<head>
  ...
  <title>Revolut Invests - Transaction logs</title>
...
<body>
  ...
  <div id="mainContent" class="main_content">
    ...
    <div class="dashboard_container">
      <section>
        <h3 class="page-title">Transaction logs</h3>
        <div class="card">
          <div class="responsive-table">
            <table>
              ...
              <tbody>
                <?php
                foreach ($Authroller->allTransactions() as $key => $value) {
                ...
                <tr>
                  ...
                  <td data-label="Type">
                    <span class="text-capitalize"><?php echo $value['type'] ?></span>
                  </td>
