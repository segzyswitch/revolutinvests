...
<body>
	...
	<main>
		...
		<div class="section mt-5 position-relative bg-attach-fixed overflow-hidden mx-auto rounded-4"
			style="background-image: url(image/img3.png); height: 70vh; max-width: 1816px;">
			...
			<div class="r-container h-100 position-relative" style="z-index: 2;">
				<div class="d-flex flex-column w-100 h-100 justify-content-center mx-auto align-items-center text-white gap-3"
					...
					<h2 class="m-0 text-white">FAQs</h2>
				...
				<div class="row row-cols-xl-2 row-cols-1">
					<div class="col mb-3">
						<div class="d-flex flex-column gap-3 w-100">
							<div class="accordion mt-3 d-flex flex-column gap-3" id="faqAccordion1">
					...
					<div class="col mb-3">
						<div class="d-flex flex-column gap-3 w-100">
							<div class="accordion mt-3 d-flex flex-column gap-3" id="faqAccordion2">
								<div class="accordion-item">
									<h2 class="accordion-header">
										<button class="accordion-button collapsed" type="button"
								...
								<div class="accordion-item">
									...
									<div id="faq10" class="accordion-collapse collapse show"
										...
										<div class="accordion-body">
											...
											capital. When you buy a bond, you're essentially lending money to the
											issuer. In return, the issuer promises to pay interest over the life of the
											bond.
										</div>
									</div>
								</div>
		...
		<div class="section">
			<div class="r-container d-flex flex-column gap-4">
				<div class="row row-cols-xl-2 row-cols-1">
					<div class="col mb-3">
						<div class="d-flex flex-column gap-3 h-100 justify-content-between pe-5">
							<div class="d-flex flex-column gap-3 mb-3">
								<div class="sub-heading">
									<h6 class="m-0">Any Question?</h6>
								</div>
								<h3>Let’s Ask Our Team About Finance and Investment</h3>
								<p>
									Whether you're a beginner or an experienced investor, this initiative aims to answer
									your questions, provide useful tips
								</p>
							</div>

							<div class="d-flex flex-row gap-3 justify-content-between">
								<a href="#" class="read-more d-flex flex-row gap-2 align-items-center">
									<i class="rtmicon rtmicon-classic-phone"></i>
									<span class="fs-6 fw-normal">0761-8523-398</span>
								</a>
								<a href="#" class="read-more d-flex flex-row gap-2 align-items-center">
									<i class="rtmicon rtmicon-envelope"></i>
									<span class="fs-6 fw-normal">hello@domainsite.com</span>
								</a>
								<a href="#" class="read-more d-flex flex-row gap-2 align-items-center">
									<i class="rtmicon rtmicon-globe"></i>
									<span class="fs-6 fw-normal">www.domainsite.com</span>
								</a>
							</div>
						</div>
					</div>
					<div class="col mb-3">
						<div
							class="d-flex flex-column gap-3 justify-content-center w-100 bg-gradient-footer p-5 rounded-4">
							<h4 class="accent-primary">Fill This Form</h4>
							<div class="position-relative w-100">
								...
								<div class="w-100">
									<div class="d-flex flex-column gap-3 p-lg-4">
										<div>
											<form
												class="contact d-flex flex-column h-100 justify-content-center w-100 needs-validation form"
												novalidate>
												<div class="mb-3">
												...
												<div class="mb-3">
													<input type="text" class="form-control py-3 px-4" name="subject"
												...
												<button type="submit"
													class="btn btn-accent submit_form py-3 rounded-3 d-flex flex-row gap-2 justify-content-center font-2">
